...
# 簡単なものから順に。凝ったものほど下
SAMPLES = ["circle", "first", "shapes", "bounce", "bars", "clock", "orbit", "fractal", "walker", "passerby", "crowd", "grid", "materials", "cube3d", "globe", "julia", "burning_ship", "mandelbrot", "report", "showcase"]
