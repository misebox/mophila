...
export interface Method { receiver: string; name: string; signature: string; doc: string }
export interface Attr { name: string; type: string; doc: string }
export interface TypeDoc { name: string; doc: string; attrs: Attr[] }
export interface LibItem { name: string; signature: string; summary: string; params: [string, string][]; returns: string }
export interface LibSection { title: string; items: LibItem[] }
export interface Lib { file: string; sections: LibSection[] }
